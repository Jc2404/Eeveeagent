...
def print_welcome() -> None:
    title = Text("Eevee Agent", style="bold #f6c177")
    subtitle = Text("Evolvable Coding Agent CLI", style="bold cyan")
    mascot = Text(EEVEE_MASCOT, style="bold #d19a66")
    ...
    body = Table.grid()
    body.add_row(Align.center(mascot))
    ...
    console.print(Panel(
        body,
        title="[bold #f6c177] Eevee Agent ready [/bold #f6c177]",
...
def print_user_prompt() -> None:
    console.print("\n[bold #f6c177]Eevee[/bold #f6c177][bold cyan] Agent[/bold cyan] [dim]❯[/dim] ", end="")
...
def print_goodbye() -> None:
    console.print(Panel(
        Text("Bye. Eevee Agent is ready for next time.", style="bold #f6c177"),
        border_style="#d19a66",
        box=box.ROUNDED,
        padding=(0, 1),
    ))
